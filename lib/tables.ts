...
export const TABLES: TableDef[] = [
  ...
  {
    name: "raw_directory_data",
    label: "Raw • Directory",
    pk: "id",
    orderBy: { col: "scraped_at", asc: false },
    listColumns: ["company_name","website","city","category","source_directory","scraped_at"],
    columns: [
      ID,
      { name: "company_name", type: "text", required: true },
  ...
  },
  {
    ...
    pk: "id",
    orderBy: { col: "scraped_at", asc: false },
    listColumns: ["company_name","city","rating","review_count","business_status","scraped_at"],
    columns: [
      ID,
      { name: "company_name", type: "text", required: true },
      { name: "website", type: "text" },
      ...
      { name: "categories", type: "text_array" },
